...
$user=User::getFromSession();
	...
	if($user->getinadmin()=='1'){
		...
		$pageAdmin= new PageAdmin(array('footer'=>false),'/views/admin/',$user->getdeslogin());		

	}else{
			$pageAdmin= new PageAdmin(array('header'=>false,'header2'=>true,'footer'=>false),'/views/admin/',$user->getdeslogin());					
	}
