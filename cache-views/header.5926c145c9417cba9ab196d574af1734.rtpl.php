<?php if(!class_exists('Rain\Tpl')){exit;}?>  <!DOCTYPE html>
      <html lang="pt-br">
        <head>
          ...
          <link rel="stylesheet" type="text/css" href="../res/css/historia.css">
          <link rel="stylesheet" type="text/css" href="../res/css/colegiados.css">
           <link rel="stylesheet" type="text/css" href="../res/css/colegiado.css">

          <link rel="stylesheet" type="text/css" href="../res/css/style.css">
           <link rel="stylesheet" type="text/css" href="../res/css/fale_conosco.css">
    ...
    <nav>
      ...
      <ul class="itensMenu">
        ...
        <li class="mostraColegiado" >
            <a   href="/" ><div class="link2">AAOC</div></a> 
             <ul class="colegiados">
                <li><div ><a class="link3" href="/" >Inicio</a></div></li>
                <li><div ><a class="link3" href="/historia" >História</a></div></li>
        ...
        <li class="mostraColegiado" >
            <a  href="/colegiados"  ><div class="link2">Colegiados</div></a>    
           <!-- <ul class="colegiados">
        ...
        <li><a href="/fale_conosco"> <div class="link2">Fale Conosco</div></a></li>
    ...
    <nav class="navigation">
        <ul class="navigation__list">
            <li class="navigation__item">
                <div class="dropdown">
                  <a href="/" class='navigation__link<?php if( $is_active==null ){ ?><?php }else{ ?><?php echo htmlspecialchars( $is_active, ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>' >AAOC</a>
            ...
            <li class="navigation__item">
                 <div class="dropdown">
                  <a href="/colegiados" class='navigation__link<?php if( $is_active1==null ){ ?><?php }else{ ?><?php echo htmlspecialchars( $is_active1, ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>' >Colegiados</a>
                  <!--<div class="dropdown-content">
            ...
            <li class="navigation__item"><a href="/fale_conosco" class='navigation__link<?php if( $is_active2==null ){ ?><?php }else{ ?><?php echo htmlspecialchars( $is_active2, ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>' >Fale Conosco</a></li>
        </ul>
