          ...
          <?php $counter1=-1;  if( isset($conselhos) && ( is_array($conselhos) || $conselhos instanceof Traversable ) && sizeof($conselhos) ) foreach( $conselhos as $key1 => $value1 ){ $counter1++; ?>
               ...
               <?php if( $line < 3 ){ ?>
                 ...
                 <div class="divContentConselho">
                        ...
                        <a class="linksConselhos" href="/colegiados/<?php echo htmlspecialchars( $value1["name_conselho"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["name_conselho"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                        <?php } ?>
