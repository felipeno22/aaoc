<?php if(!class_exists('Rain\Tpl')){exit;}?>
            ...
            <article>
                ...
                <section> <!--Sessao  dados conselho-->
                    ...
                    <fieldset>
                        ...
                        <p>
                            1. Lei n° 2.784 de 27 de dezembro de 1990;<br> 
                            2. Lei n° 2.811 de 07 de junho de 1991;<br> 
                            3. Decreto n° 6.340 de 02 de agosto de 1991;<br> 
                            4. Lei n° 3.013 de 30 de novembro de 1993;<br> 
                            5. Lei n° 3.780 de 21 de agosto de 2000;<br> 
                            6. Lei n° 4.234 de 18 de novembro de 2004;<br> 
                            7. Decreto n° 8.099 de 31 de outubro de 2000.<br>
                        </p>
 ...
 <br>
            ...
            <section><!-- aside  dados noticias-->
                    ...
                    <fieldset>
                         <legend><img id="ultimasnoticias" src="../res/img/ultimasnoticias.png" alt="image not found"></legend>
                        ...
                        <?php $counter1=-1;  if( isset($noticias) && ( is_array($noticias) || $noticias instanceof Traversable ) && sizeof($noticias) ) foreach( $noticias as $key1 => $value1 ){ $counter1++; ?>
                         <div style="padding-top:20px ;">
                                <img style="border:2px solid black;" src="..<?php echo htmlspecialchars( $value1["imginformation"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="image not found" width="250" height="200"> 
                                
                                <h4><?php echo htmlspecialchars( $value1["title"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <small>publicado: <?php echo htmlspecialchars( $value1["dtinformation"], ENT_COMPAT, 'UTF-8', FALSE ); ?></small></h4>

                                
                               <p> <?php echo htmlspecialchars( $value1["information"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
