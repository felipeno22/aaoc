...
<div  class="tela_listaLegis">
  ...
  <h2 id="titleListLegis">
    Lista de minhas Legislações
  </h2>



   <div class="divsearchLegis">
                <form action='/mylegislacao'>
                    ...
                    <button id="btbuscaLegis" type="submit" id="btcad"><i class="fa fa-search">buscar</i></button>
  ...
  <a id="insertLegisLink" href="/mylegislacao/insert">Cadastrar Informativo</a>
              ...
              <table id="tbLegis" >
                <thead>
                  <tr>
                    ...
                    <th  style="width:250px">Legislção</th>
                     <th hidden>iduser</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                <a  id="updateLegisLink" href="/myupdateLegis/<?php echo htmlspecialchars( $value1["idlegislacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                  <a  id="deleteLegisLink"  href="/mylegislacao/delete/<?php echo htmlspecialchars( $value1["idlegislacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                   </tr>
                  <?php } ?>
