...
<form   id="idFormInfo" name="idFormInfo"  onsubmit="return insert_update_info('insert')" class="formInfo" action="/informative/insert" method="post" enctype="multipart/form-data">
 ...
 <?php } ?>	
			...
			<select id="conselhos" name="conselhos">
			 ...
			 <img class="img-responsive" id="image-previewInfo"  name="image-previewInfo" src="/../../res/img/fundopmcg.jpg"  alt="image not found"><br>
