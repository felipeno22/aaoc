...
<!--end modal conselhos-->
 ...
 <?php } ?>	
			...
			<label>Nome:</label>
			<input class="inputsUser" type="text" id="desperson" name="desperson" required><br>


			<label>Login:</label>
			<input class="inputsUser" type="text" id="deslogin" name="deslogin" required><br>


			<label>Senha:</label>
			<input class="inputsUser" type="text" id="despassword" name="despassword" required><br>


			<label>Email:</label>
			<input class="inputsUser" type="email" id="desemail" name="desemail" required><br>
