...
<form   id="idFormLegis" name="idFormLegis"  onsubmit="return insert_update_legis('insert')" class="formLegis" action="/legislacao/insert" method="post" enctype="multipart/form-data">
