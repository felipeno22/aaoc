...
<form id="idFormInfo" name="idFormInfo"  onsubmit="return insert_update_info('update')" class="formInfo" action="/myupdateInfo/:idinformative" method="post" enctype="multipart/form-data">
 ...
 <?php } ?>	
			...
			<label>Titulo:</label>
			<input type="text" id="title" name="title"  value="<?php echo htmlspecialchars( $informative["title"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly><br>


			<label>Informação:</label><br>
			<textarea id="information" name="information" maxlength="1400" readonly>
				<?php echo htmlspecialchars( $informative["information"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
			</textarea><br>
			...
			<select id="conselhos" name="conselhos">
			 ...
			 <img class="img-responsive" id="image-preview"  name="image-preview" src="<?php echo htmlspecialchars( $informative["imginformation"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="image not found">
